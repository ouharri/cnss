...
public class KeyedHandler<K> extends AbstractKeyedHandler<K, Map<String, Object>> {
     ...
     */
    public KeyedHandler() {
        this(com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.handlers.ArrayHandler.ROW_PROCESSOR, 1, null);
    }
    ...
    public KeyedHandler(final int columnIndex) {
        this(com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.handlers.ArrayHandler.ROW_PROCESSOR, columnIndex, null);
    }
