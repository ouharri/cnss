...
public abstract class AbstractQueryRunner {
    ...
    protected void close(final Connection conn) throws SQLException {
        com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils.close(conn);
    }
    ...
    protected void close(final ResultSet resultSet) throws SQLException {
        com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils.close(resultSet);
    }
    ...
    protected void close(final Statement stmt) throws SQLException {
        com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils.close(stmt);
    }

    /**
     * Calls {@link com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils#closeQuietly(Connection)}.
     *
     * @param conn Connection to close.
     * @since 1.8.0
     */
    protected void closeQuietly(final Connection conn) {
        com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils.closeQuietly(conn);
    }

    /**
     * Calls {@link com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils#closeQuietly(ResultSet)}.
     *
     * @param resultSet ResultSet to close.
     * @since 1.8.0
     */
    protected void closeQuietly(final ResultSet resultSet) {
        com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils.closeQuietly(resultSet);
    }

    /**
     * Calls {@link com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.DbUtils#closeQuietly(Statement)}.
     *
...
//            System.out.println( params[i].toString());
            if (params[i] != null) {
                if (call != null && params[i] instanceof com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.OutParameter) {
//                    System.out.println(2);
//                    System.out.println( params[i].toString());
                    ((OutParameter<?>) params[i]).register(call, i + 1);
                } else {
//                    if(params[i] instanceof smiyaMoa9ata){
