 ...
 * variable inside the {@link com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.ResultSetHandler#handle(ResultSet)} over and over for each iteration
 ...
 * @since 1.6
 */
public abstract class BaseResultSetHandler<T> implements com.macnss.Libs.orm.src.main.java.org.apache.commons.dbutils.ResultSetHandler<T> {
